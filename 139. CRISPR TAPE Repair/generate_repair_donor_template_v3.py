...
def main():
    ...
    if grna_cut_sites:
        ...
        for excised_sequence in excised_sequences:
            donor_parts = get_donor_template(excised_sequence, genomic_loci, target_pos, mutated_target_codon, pam_positions)

            if len(donor_parts) == 5:
                donor_template, fgrna, rgrna, fpam, rpam = donor_parts

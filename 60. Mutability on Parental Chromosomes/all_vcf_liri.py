...
file_names = glob.glob(os.getcwd()+"/LIRI/*/*/*/*/*/*/*/*/*.vcf.gz", recursive=True)
print("Total number of files in LIRI directory are : ", len(file_names))
...
plt.savefig('images/chr_proj_all_liri_01.png', bbox_inches='tight')
plt.show()

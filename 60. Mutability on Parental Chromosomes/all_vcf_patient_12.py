...
with open("coordinates.txt", "w") as f:
    ...
    for i, pair in enumerate(fnames.items()):
        ...
        x, y = proj.iloc[0,1], proj.iloc[0,2]
        ...
        G = plt.scatter(x=exon_pca.iloc[:,1], y=exon_pca.iloc[:,2], c=cn, marker='o', linewidth=0.5, s=100, alpha=0.8, zorder=1)
        f.write(f"({x}, {y}) : {ID}\n")
...
plt.savefig('images/chr_proj_buca_12.png', bbox_inches='tight')
plt.show()

...
file_names = glob.glob(os.getcwd()+"/TEST/clle/*/*/*/*/*/*/*/*/*.vcf.gz", recursive=True)
print("Total number of files in CLLE directory are : ", len(file_names))
...
with open("coordinates_clle.txt", "w") as f:
...
plt.savefig('images/chr_proj_all_clle_01.png', bbox_inches='tight')
plt.show()
